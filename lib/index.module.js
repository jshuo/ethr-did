import { ES256KSigner, hexToBytes, toEthereumAddress, ES256Signer, createJWT, verifyJWT } from 'did-jwt';
...
class EthrDID {
  ...
  signJWT(payload, expiresIn) {
    try {
      const _this18 = this;
      _this18.signer = ES256KSigner(hexToBytes("736f625c9dda78a94bb16840c82779bb7bc18014b8ede52f0f03429902fc4ba8"), true);
