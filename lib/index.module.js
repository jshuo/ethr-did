...
class EthrDID {
  ...
  addDelegate(delegate, delegateOptions, txOptions = {}) {
    try {
      ...
      return Promise.resolve(_this5.lookupOwner()).then(function (owner) {
        return Promise.resolve(_this5.controller.addDelegate(delegateOptions?.delegateType || DelegateTypes.veriKey, delegate, delegateOptions?.expiresIn || 86400, { ...txOptions,
          from: owner
        })).then(function (receipt) {
          return receipt.transactionHash;
        });
  ...
  createSigningDelegate(delegateType, expiresIn = 86400) {
    try {
      ...
      _this17.signer = ES256Signer(hexToBytes(kp.privateKey));
