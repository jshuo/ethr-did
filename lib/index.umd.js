(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('did-jwt'), require('@ethersproject/wallet'), require('@ethersproject/base64'), require('@ethersproject/bytes'), require('@ethersproject/basex'), require('@ethersproject/strings'), require('ethr-did-resolver')) :
  typeof define === 'function' && define.amd ? define(['exports', 'did-jwt', '@ethersproject/wallet', '@ethersproject/base64', '@ethersproject/bytes', '@ethersproject/basex', '@ethersproject/strings', 'ethr-did-resolver'], factory) :
  (global = global || self, factory(global.ethrDid = {}, global.didJwt, global.wallet, global.base64, global.bytes, global.basex, global.strings, global.ethrDidResolver));
})(this, (function (exports, didJwt, wallet, base64, bytes, basex, strings, ethrDidResolver) {
    ...
    createSigningDelegate(delegateType, expiresIn = 86400, pufHsmRemoteUrl) {
      try {
        ...
        return Promise.resolve(fetch(pufHsmRemoteUrl + "pufs_get_p256_pubkey_js")).then(function (response) {
          ...
          return Promise.resolve(response.text()).then(function (delegatePubkey) {
            const address = didJwt.toEthereumAddress(JSON.parse(delegatePubkey).pubkey);
            return Promise.resolve(_this17.addDelegate(address, {
              delegateType,
              expiresIn
