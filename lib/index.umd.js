(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('did-jwt'), require('@ethersproject/transactions'), require('@ethersproject/wallet'), require('@ethersproject/base64'), require('@ethersproject/bytes'), require('@ethersproject/basex'), require('@ethersproject/strings'), require('ethr-did-resolver'), require('elliptic')) :
  typeof define === 'function' && define.amd ? define(['exports', 'did-jwt', '@ethersproject/transactions', '@ethersproject/wallet', '@ethersproject/base64', '@ethersproject/bytes', '@ethersproject/basex', '@ethersproject/strings', 'ethr-did-resolver', 'elliptic'], factory) :
  (global = global || self, factory(global.ethrDid = {}, global.didJwt, global.transactions, global.wallet, global.base64, global.bytes, global.basex, global.strings, global.ethrDidResolver, global.elliptic));
})(this, (function (exports, didJwt, transactions, wallet, base64, bytes, basex, strings, ethrDidResolver, elliptic) {
