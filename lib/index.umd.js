(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('did-jwt'), require('@ethersproject/wallet'), require('@ethersproject/base64'), require('@ethersproject/bytes'), require('@ethersproject/basex'), require('@ethersproject/strings'), require('ethr-did-resolver'), require('crypto'), require('elliptic')) :
  typeof define === 'function' && define.amd ? define(['exports', 'did-jwt', '@ethersproject/wallet', '@ethersproject/base64', '@ethersproject/bytes', '@ethersproject/basex', '@ethersproject/strings', 'ethr-did-resolver', 'crypto', 'elliptic'], factory) :
  (global = global || self, factory(global.ethrDid = {}, global.didJwt, global.wallet, global.base64, global.bytes, global.basex, global.strings, global.ethrDidResolver, global.crypto, global.elliptic));
})(this, (function (exports, didJwt, wallet, base64, bytes, basex, strings, ethrDidResolver, crypto, elliptic) {
