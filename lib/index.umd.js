(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('did-jwt'), require('@ethersproject/transactions'), require('@ethersproject/signing-key'), require('@ethersproject/wallet'), require('@ethersproject/base64'), require('@ethersproject/bytes'), require('@ethersproject/basex'), require('@ethersproject/strings'), require('ethr-did-resolver'), require('elliptic')) :
  typeof define === 'function' && define.amd ? define(['exports', 'did-jwt', '@ethersproject/transactions', '@ethersproject/signing-key', '@ethersproject/wallet', '@ethersproject/base64', '@ethersproject/bytes', '@ethersproject/basex', '@ethersproject/strings', 'ethr-did-resolver', 'elliptic'], factory) :
  (global = global || self, factory(global.ethrDid = {}, global.didJwt, global.transactions, global.signingKey, global.wallet, global.base64, global.bytes, global.basex, global.strings, global.ethrDidResolver, global.elliptic));
})(this, (function (exports, didJwt, transactions, signingKey, wallet, base64, bytes, basex, strings, ethrDidResolver, elliptic) {
  ...
  class EthrDID {
    ...
    addDelegate(delegate, delegateOptions, txOptions = {}) {
      try {
        ...
        return Promise.resolve(_this5.lookupOwner()).then(function (owner) {
          return Promise.resolve(_this5.controller.addDelegate(delegateOptions?.delegateType || exports.DelegateTypes.veriKey, delegate, delegateOptions?.expiresIn || 86400, { ...txOptions,
            from: owner
          })).then(function (receipt) {
            return receipt.transactionHash;
          });
    ...
    revokeDelegate(delegate, delegateType, txOptions = {}) {
      try {
        ...
        return Promise.resolve(_this8.lookupOwner()).then(function (owner) {
          return Promise.resolve(_this8.controller.revokeDelegate(delegateType, delegate, { ...txOptions,
            from: owner
          })).then(function (receipt) {
            return receipt.transactionHash;
          });
    ...
    createSigningDelegate(delegateType, expiresIn = 86400) {
      try {
        ...
        _this17.signer = didJwt.ES256Signer(didJwt.hexToBytes(kp.privateKey));
